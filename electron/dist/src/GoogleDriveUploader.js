...
class GoogleDriveUploader {
    ...
    async uploadFile(filePath, options = {}) {
        ...
        try {
            ...
            const remotePath = this.getRemotePath(options, filePath);
            ...
            // Add verbose logging
            args.push('--verbose');
            logger_1.default.info(`Uploading file to Google Drive: ${path.basename(filePath)}`);
            ...
            logger_1.default.info(`Successfully uploaded: ${path.basename(filePath)} to ${remotePath}`);
        }
        catch (error) {
